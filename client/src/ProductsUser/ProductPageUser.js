...
function ProductPage({ branduserProduct }) {
    ...
    function confirDeletePost(){ 
        ...
        if(answer) {
            dispatch(deleteProduct(jwt.token, productId));    
        }
    };
        ...
        <div className="card mb-2 border border-primary">
            <div className="card-header bg-light">
                <div className="d-flex flex-row justify-content-start">
                    <div className="post-by">
                        ...
                        src={`http:localhost:5000/branduser/photo/${userId}?${new Date().getTime()}`} 
            ...
            <div className="card-footer">
                <div className="d-flex flex-row justify-content-center align-items-center">
                    ...
                    {branduserProduct.brand.branduser._id === userId && 
