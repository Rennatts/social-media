...
export const list = () => {
    return fetch(`http://localhost:5000/users/allusers`, {
        method: "GET",
    })
    .then(res => {
        return res.json();
...
export const follow = ( userId, token, followId ) => {
    ...
    return fetch("http://localhost:5000/users/user/follow", {
        method: "PUT",
        headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`
...
export const unfollow = ( userId, token, followId ) => {
    try{ return fetch("http://localhost:5000/users/user/unfollow", {
        method: "PUT",
        headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`
...
export const comment = (userId, token, postId, comment) => {
    fetch(`http://localhost:5000/posts/post/addcomment`, {
        method: "PUT", 
        headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`,
...
export const deletecomment = (userId, token, postId, comment) => {
    fetch(`http://localhost:5000/posts/post/deletecomment`, {
        method: "PUT", 
        headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`,
